...
|remove_on_absent|vars|<ul><li>network_interfaces</li><li>virtual_storage</li><li>public_ips</li><ul>|List of additional VM resources to delete. Default is no additional resources |
